...
function _get_sub_cat_id($update_id){
    ...
    //echo $refer_url."<hr>";
    //http://localhost/cishop/music/instruments/JBL-Bluetooth
...
function _get_best_sub_cat_id($update_id){
    ...
    if($num_sub_cats_for_item==1){
        ...
        //we hwve more than on sub cat start
...
function _process_delete($update_id){
    ...
    //attempt to delete item big pic
    $data=$this->fetch_data_from_db($update_id);
    $big_pic=$data['big_pic'];
    $small_pic=$data['small_pic'];
    $big_pic_path='./big_pic/'.$big_pic;
...
function delete($update_id){
    ...
    if($submit=="Cancel"){
        redirect('store_items/create/'.$update_id);
         ...
         $flash_msg="The Item Have been Delete";
...
function delete_image($update_id)
{
    ...
    $flash_msg="The Image have been remove";
    $value='<div class="alert alert-success" role="alert">'.$flash_msg.'</div>';
    $this->session->set_flashdata('item',$value);
...
function _generate_thumbnail($file_name){
        ...
        $config['source_image'] = './big_pic/'.$file_name;
...
//star function create
 function create(){
    ...
    $this->site_security->_make_sure_is_admin();
     ...
     if($submit=="Submit"){
        $this->load->library('form_validation');
        $this->form_validation->set_rules('item_title','Item_Title','required|max_length[240]|callback_item_check');
        $this->form_validation->set_rules('item_price','Item_Price','required|numeric');
        $this->form_validation->set_rules('was_price','Was_Price','numeric');
         $this->form_validation->set_rules('status','status','required|numeric');
         $this->form_validation->set_rules('item_description','item_Description','required');
         ...
         if($this->form_validation->run()==TRUE){
            ...
            if (is_numeric($update_id)) {
                ...
                $flash_msg="This item was successfully update.";
                $value='<div class="alert alert-success" role="alert">'.$flash_msg.'</div>';
                $this->session->set_flashdata('item',$value);
                redirect('store_items/create/'.$update_id);
            }else{
                ...
                $flash_msg="This item was successfully Save.";
                $value='<div class="alert alert-success" role="alert">'.$flash_msg.'</div>';
                $this->session->set_flashdata('item',$value);
                redirect('store_items/create/'.$update_id);
            }
