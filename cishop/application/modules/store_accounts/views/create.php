...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Accounts Options</h2>
						<div class="box-icon">
					...
					?>
						<form class="form-horizontal" method="post" action="<?= $form_location ?>">
						  <fieldset>
							...
							<div class="control-group"> <label class="control-label" for="typeahead">Phone Number </label> <div class="controls"> <input type="text" class="span6" name="telnum" value="<?= $telnum ?>"> </div> </div>
							...
							<!--<div class="control-group"> <label class="control-label" for="typeahead">Date_made </label> <div class="controls"> <input type="text" class="span6" name="date_made" value="<?= $date_made ?>"> </div> </div>

							<div class="control-group"> <label class="control-label" for="typeahead">Pword </label> <div class="controls"> <input type="text" class="span6" name="pword" value="<?= $pword ?>"> </div> </div>-->
